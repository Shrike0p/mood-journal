...
function onChange(theme: Theme, setTheme: (theme: Theme) => void) {
    ...
    (window as unknown as CustomWindow)._updateTheme(theme);
    setTheme(theme);
}
...
export default function ThemeToggle() {
    ...
    return (
        <RadioGroup
            value={theme}
            onChange={(value: Theme) => onChange(value, setTheme)}
            className="relative z-0 inline-grid grid-cols-3 gap-0.5 rounded-full bg-gray-950/20 p-0.75 text-gray-950 dark:bg-white/10 dark:text-white"
        >
